...
//		ArrayList a=new ArrayList(50);
		Vector<Object> a=new Vector<>();//by default capacity 10
...
//		System.out.println(i.next());
		...
		ListIterator<Object> l=a.listIterator();//ListIterator(sub interface of Iterator) works with List ONLY (not with Set or Map).
