...
public class Collection6
 {
	...
	public static void main(String[] args) {
		ArrayList<Object> a=new ArrayList<>(50);//version-1.2, methods are not synchronized,Only Capacity is allowed(not Increment Size),Iterator & ListIterator allowed(Enumeration not allowed)
